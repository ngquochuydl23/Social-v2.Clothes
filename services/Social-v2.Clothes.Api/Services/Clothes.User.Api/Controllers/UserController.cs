...
using Clothes.Commons.Validators;
...
using Clothes.User.Api.Validators;
...
namespace Clothes.User.Api.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        {
            ValidationResult validationResult = Validator.Validate<SignUpValidator, SignUpDto>(signUpDto);
