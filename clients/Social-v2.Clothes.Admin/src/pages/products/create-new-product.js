            ...
            <Stack spacing={3}>
              ...
              <form onSubmit={formik.handleSubmit}>
                ...
                <Typography sx={{ marginY: "10px", width: "50%" }} variant="caption">
                  Give your product a short and clear title. 50-60 characters is the recommended
                ...
                />
                <Typography sx={{ marginY: "10px", width: "50%" }} variant="caption">
                  Give your product a short and clear description. 120-160 characters is the
                ...
                <FormControlLabel
                  ...
                  control={
                    <Switch
                      id="isDiscountable"
                      checked={formik.values.isDiscountable}
                      onChange={formik.handleChange}
                      color="primary"
                    />
                  }
