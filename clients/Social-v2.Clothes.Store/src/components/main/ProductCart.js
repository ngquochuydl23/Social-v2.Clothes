...
const NoProductAddedAlert = () => (
    <div
        ...
        <div>
            <span className="font-medium">Cảnh báo!</span> Chưa có sản phẩm trong giỏ hàng
        </div>
    </div>
);
        ...
        <div
            ...
            <div className="relative h-24 w-20 flex-shrink-0 overflow-hidden rounded-xl bg-slate-100">
                <LazyLoadingImage
                    ...
                    height={"96"}
                    width={"80"}
                    className={"object-contain object-center h-24 w-20"}
                />
            </div>
                                        ...
                                        <p className="flex justify-between font-semibold text-slate-900">
                                            <span>
                                                ...
                                                <span className="block text-sm text-slate-500 font-normal">
                                                    Chưa bao gồm thuế và phí ship.
                                                </span>
                                            </span>
                                            <span className="">{1000000}d</span>
                                        </p>
