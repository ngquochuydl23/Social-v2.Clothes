    ...
    return (
        <>
            {loading ? (
                ...
                <section className="container mx-auto px-4 mt-[40px] lg:px-32 flex flex-col gap-y-32 scroll-smooth">
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-12">
                        <div className="flex flex-col gap-y-4">
                            <LazyLoadingImage
                                ...
                                className={"max-w-full  w-full object-cover rounded-2xl"}
                            />
                            <div className="grid grid-cols-4 gap-2">
                                {productVarient.varientMedias?.map((image) => (
                                    <LazyLoadingImage
                                        key={image.url}
                                        height={"135"}
                                        width={"100%"}
                        ...
                        <div className="flex flex-col gap-y-8">
                            <div className="flex flex-col gap-y-1">
                                ...
                                <h4 className="text-1xl sm:text-1xl mt-[20px] font-regular text-gray-700">{product.subtitle}</h4>
                            ...
                            <div className="flex flex-wrap gap-y-2">
                                {product.options?.map(({ title, optionValues }, index) => (
                                    <Stack
                                        sx={{ width: '100%' }}
                                        direction="column">
                                        <Stack direction="row">
